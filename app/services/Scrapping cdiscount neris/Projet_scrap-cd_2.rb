...
# tab << get_data_product('https://www.cdiscount.com/telephonie/accessoires-portable-gsm/lot-3-films-protection-samsung-galaxy-note-8-pla/f-144201315-pho2009649552114.html?idOffre=207843006')
...
for i in 40.step( 62, 1 )
    tab=scrap_links_for_all_webpages( i*10 + 1, i*10 +10 )
    tab.each {|pr| p pr}
    save_data_in_CSV_file(tab)
end
