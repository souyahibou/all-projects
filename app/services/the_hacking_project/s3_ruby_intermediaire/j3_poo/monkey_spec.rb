...
describe TheHackingProject::S3RubyIntermediaire::J3Poo::Monkey do

  # each `it` tests a specific functionality of our Monkey objects
  it "has a name" do
    # often we start a test by setting up a specific state
    adam = TheHackingProject::S3RubyIntermediaire::J3Poo::Monkey.new("Adam", "Spider Monkey")
  ...
  it "has a species" do
    andy = TheHackingProject::S3RubyIntermediaire::J3Poo::Monkey.new("Andy", "Cool Monkey")

    expect(andy.species).to eq("Cool Monkey")
  end

  it "starts with no foods eaten" do
    adrian = TheHackingProject::S3RubyIntermediaire::J3Poo::Monkey.new("Adrian", "White-headed Capuchin")

    expect(adrian.foods_eaten).to eq([])
  end

  it "can eat a food (a string)" do
    matt = TheHackingProject::S3RubyIntermediaire::J3Poo::Monkey.new("Matt", "Mandrill")
    matt.eat("banana")
    matt.eat("PB&J")
  ...
  it "can introduce itself with name, species, and foods eaten" do
    jesse = TheHackingProject::S3RubyIntermediaire::J3Poo::Monkey.new("Jesse", "Dusky Leaf Monkey")
  ...
  it "always has a capitalized name" do
    robin = TheHackingProject::S3RubyIntermediaire::J3Poo::Monkey.new("robin", "Olive Baboon")
