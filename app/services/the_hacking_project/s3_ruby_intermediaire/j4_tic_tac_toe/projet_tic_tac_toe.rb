...
module TheHackingProject
		module S3RubyIntermediaire
				module J4TicTacToe
						class ProjetTicTacToe
                def initialize
                    puts " ;)"
                    @path = "app/services/the_hacking_project/s3_ruby_intermediaire/j4_tic_tac_toe/"
                    ...
                    # rspec projet_morpion_spec.rb --format html --out rspec_results.html
                    #/J4_tic_tac_toe/Projet_tic-tac-toe_P2S3_V2.rb => j4_tic_tac_toe/projet_tic-tac-toe.rb
                end

                def run_spec
                    %x!rspec #{File.join(@path,"projet_morpion_spec.rb")} --format html --out #{File.join(@path,"rspec_results.html")}!
                ...
                class Player
                      ...
                      def initialize(the_name, the_status, the_sign)
