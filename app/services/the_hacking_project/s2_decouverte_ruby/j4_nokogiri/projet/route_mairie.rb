 		...
 		module S2DecouverteRuby
 				module J4Nokogiri
                     ...
                     def save_data_in_CSV_file(table_data)  #added
                        CSV.open(File.join(@path, "route_mairie.csv") , "a") do |csv|
                     ...
                     def perform
                         save_data_in_CSV_file( array_of_cities_data = get_all_the_urls_of_val_doise_townhalls() )
                         puts array_of_cities_data.count
                         array_of_cities_data
                     end
         		    end
 						end
 				end
