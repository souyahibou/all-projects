module Projects
  class ThpController < ApplicationController
      ...
      #
        ...
        def oeuvres1_2
            redirect_to c_v_webpage_path
        end
        def oeuvres1_3
            redirect_to google_page1_path
        end
        def oeuvres1_4
            arguments = { "google"   =>  Proc.new {redirect_to google_page2_path and return},
                          "mozilla"  =>  Proc.new {redirect_to mozilla_page_path and return},
            }
